...
def feedforward(input_image):
    a = []
    a.append(input_image.reshape(-1, 1))
...
X_train, X_val, y_train, y_val = train_test_split(train_x, train_y_onehot, test_size=10000, random_state=1)
# X_train = X_train / 255 * 0.99 + 0.01
# X_val = X_val / 255 * 0.99 + 0.01
